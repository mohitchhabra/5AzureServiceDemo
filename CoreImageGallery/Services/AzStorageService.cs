...
namespace CoreImageGallery.Services
{
    public class AzStorageService : IStorageService
    {
        ...
        {
            _connectionString = "DefaultEndpointsProtocol=https;AccountName=bdotnetdemo;AccountKey=hWhCflbbHB27iXei9BlyYgmLjN0TwfeHAiu/vb3a10u/Nv+2d/lCnEhHVV3rj4/u96ajyiJVUc2wtD5i8KBovA==;EndpointSuffix=core.windows.net";
